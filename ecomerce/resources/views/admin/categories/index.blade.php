    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <div class="space-y-1">
            <h1 class="text-3xl font-black text-slate-900 tracking-tight flex items-center gap-3">
                <span class="p-2.5 bg-blue-600 text-white rounded-2xl shadow-md shadow-blue-600/10 flex items-center justify-center">
                    <i class="fas fa-tags text-xl"></i>
                </span>
                Gestion des Catégories
            </h1>
            <p class="text-sm text-slate-500 font-medium pl-1">Gérez vos catégories de produits, descriptions et inventaires.</p>
        </div>
    </div>
    ...
    <div class="grid lg:grid-cols-3 gap-8 items-start">
        ...
        <div class="bg-white rounded-3xl border border-slate-100 shadow-[0_10px_30px_rgba(148,163,184,0.08)] p-6 group transition-all duration-300 hover:shadow-md">
            ...
            <form action="{{ route('categories.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            type="text"
                            name="name"
                            class="w-full pl-9 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl font-medium text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-sm"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <textarea
                            name="description"
                            rows="4"
                            class="w-full pl-9 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl font-medium text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-sm"
                ...
                <button
                    type="submit"
                    class="w-full inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold px-6 py-3.5 rounded-xl text-sm transition-all shadow-md shadow-blue-600/10 hover:shadow-lg active:scale-[0.99]"
                >
                ...
                <table class="w-full border-collapse text-left">
                    ...
                    @forelse($categories as $category)
                        <tr class="hover:bg-slate-50/50 transition-colors group/tr">
                            ...
                            <td class="p-4">
                                <div class="font-bold text-slate-900 group-hover/tr:text-blue-600 transition-colors">
                                    {{ $category->name }}
                                </div>
                            ...
                            <td class="p-4 text-center">
                                <span class="inline-flex items-center justify-center px-2.5 py-1 text-xs font-black bg-blue-50 text-blue-600 border border-blue-100 rounded-lg min-w-[32px]">
        ...
        <form id="editCategoryForm" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input
                    ...
                    id="modal_name"
                    name="name"
                    class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl font-medium text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-sm"
                    required
                >
            </div>
            ...
            <div>
                ...
                <textarea
                    ...
                    name="description"
                    rows="3"
                    class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl font-medium text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-sm"
                ></textarea>
            </div>
            ...
            <div class="flex justify-end gap-3 pt-2">
                ...
                <button 
                    type="submit" 
                    class="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl text-xs uppercase tracking-wider transition-colors shadow-md shadow-blue-600/10"
                >
                    Mettre à jour
                </button>
            </div>
...
<script>
    function openEditModal(id, name, description) {
        ...
        // Dynamically structure the route url for laravel update endpoint
        form.action = `/categories/${id}`; 

        // Unhide classes smoothly
