...
<head>
    ...
    <!-- Fonts d Google (Plus Jakarta Sans) lli hiya f l-muda daba -->
    ...
    <style>
        ...
        /* Custom dynamic background animation for Hero */
        .animated-mesh {
...
<section class="relative overflow-hidden pt-24 pb-20 px-6 max-w-7xl mx-auto flex flex-col items-center text-center">
    ...
    <!-- Floating Tag with small animation -->
...
<!-- FEATURES SECTION (Cards with modern hover grid triggers) -->
